...
public class GoogleMail {
	...
	//휴먼처리
	public void send_certification_code_dormancy(String recipient, String certification_code, String id) throws Exception {
		...
		// 제목 설정
		String subject = "[ 고고닭 ] " + id + " 고객님, 휴면 해제 인증번호 입니다.";
		msg.setSubject(subject);
		...
		msg.setContent("<div style=\"width: 50%; margin: 3% auto; border: 1px solid #ddd;\">"
					 ...
					 + "			<div style=\"background: #fbc02d; padding: 10px 20px;\">"
					 + "				<h4>기분 좋은 쇼핑이 될 수 있도록 최선을 다하겠습니다.</h4>\n"
					 + "				<h3><span style=\"font-size: 24pt; font-weight: bold;\">요청하신 휴면 해제 인증번호</span>를 알려드립니다.</h3>"
					 + "			</div>"
					 + "			<br>"
					 + "			<p>안녕하세요 고객님, <span style=\"font-weight: bold;\">고고닭</span> 입니다.</p>"
					 + "			<p>저희 쇼핑몰을 다시 찾아주셔서 진심으로 감사드립니다.</p>"
					 + "			<p><span style=\"font-weight: bold;\"> " + id + "</span> 고객님께서 요청하신  휴면 해제 인증번호는 다음과 같습니다.</p>"
					 + "			<br>"
					 + "			<p>▣&nbsp;&nbsp;가입정보</p>"
					 + "			<table>"
					 + "				<tbody>"
					 ...
					 + "			<p>·&nbsp;인증번호 입력창에 인증번호를 정확히 입력해주세요.</p>"
					 + "			<br>"
					 + "			<p>다시 한번 저희 쇼핑몰을 찾아주신 <span style=\"font-weight: bold;\"> " + id + "</span> 고객님께 진심으로 감사드립니다.</p>"
					 + "			<p>앞으로도 많은 관심 부탁드립니다&nbsp;:)</p>"
					 + "		</div>"
				     + "		<br>"
					 + "		<div style=\"background: #ddd; color: #fff; padding: 10px 20px;\">"
