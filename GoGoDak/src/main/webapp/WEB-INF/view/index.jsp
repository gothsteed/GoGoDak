...
<section class="inner_page">
	<div class="container">
		<ul class="nav justify-content-center text-center">
			<li class="nav-item"><a class="nav-link" href="<%=ctxPath%>/product.dk?type=chicken"><img src="<%=ctxPath%>/images/index/side_img_1.png" width="100" alt="..." /><br> <span class="h4 mt-3 text-body" style="display: block;">닭가슴살</span></a></li>
			<li class="nav-item"><a class="nav-link" href="<%=ctxPath%>/product.dk?type=fried_rice"><img src="<%=ctxPath%>/images/index/side_img_2.png" width="100" alt="..." /><br> <span class="h4 mt-3 text-body" style="display: block;">도시락·볶음밥</span></a></li>
			<li class="nav-item"><a class="nav-link" href="<%=ctxPath%>/product.dk?type=bakery"><img src="<%=ctxPath%>/images/index/side_img_3.png" width="100" alt="..." /><br> <span class="h4 mt-3 text-body" style="display: block;">베이커리</span></a></li>
			<li class="nav-item"><a class="nav-link" href="<%=ctxPath%>/product.dk?type=dessert"><img src="<%=ctxPath%>/images/index/side_img_4.png" width="100" alt="..." /><br> <span class="h4 mt-3 text-body" style="display: block;">착한간식</span></a></li>
		</ul>
	</div>
</section>
			...
			<div id="recipeCarousel" class="carousel slide w-100" data-ride="carousel">
				<div class="carousel-inner w-100" role="listbox">
					...
					<div class="carousel-item text-center">
						<div class="col-md-4">
							<div class="card">
								<a href="<%=ctxPath%>/product/detail.dk?product_seq=1"><img class="img-fluid card-img-top" src="<%=ctxPath%>/images/index/time_sale_3.jpg" alt="..."></a>
								<div class="card-body">
									<h4 class="card-title text-danger font-weight-bold">[ 타임특가 ]</h4>
									<h5 class="card-text font-weight-bold">닭가슴살 에스닉볶음밥 5종 세트</h5>
									<a href="#" class="h6 text-dark">18,900원</a>&nbsp;&nbsp;&nbsp;
									<del class="text-secondary">37,500원</del>
								</div>
							</div>
						</div>
					</div>
					<div class="carousel-item text-center">
						<div class="col-md-4">
							<div class="card">
								<a href="<%=ctxPath%>/product/detail.dk?product_seq=104"><img class="img-fluid card-img-top" src="<%=ctxPath%>/images/index/time_sale_4.jpg" alt="..."></a>
								<div class="card-body">
									<h4 class="card-title text-danger font-weight-bold">[ 타임특가 ]</h4>
									<h5 class="card-text font-weight-bold">닭가슴살 사각피자 2종 6팩</h5>
									<a href="#" class="h6 text-dark">16,900원</a>&nbsp;&nbsp;&nbsp;
									<del class="text-secondary">30,500원</del>
								</div>
							</div>
						</div>
					</div>
					<div class="carousel-item text-center">
						<div class="col-md-4">
							<div class="card">
								<a href="<%=ctxPath%>/product/detail.dk?product_seq=2"><img class="img-fluid card-img-top" src="<%=ctxPath%>/images/index/time_sale_5.jpg" alt="..."></a>
								<div class="card-body">
			...
			<div class="card">
				...
				<div class="card-body">
					<div class="row justify-content-around">
						...
						<div class="col-5 col-lg-5">
							<span class="fa fa-star checked text-warning"></span> <span class="fa fa-star checked text-warning"></span> <span class="fa fa-star checked text-warning"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span>
						</div>
					</div>
					<br>
			...
			<div class="card">
				...
				<div class="card-body">
					<div class="row justify-content-around">
						...
						<div class="col-5 col-lg-5">
							<span class="fa fa-star checked text-warning"></span> <span class="fa fa-star checked text-warning"></span> <span class="fa fa-star checked text-warning"></span> <span class="fa fa-star checked text-warning"></span> <span class="fa fa-star checked text-warning"></span>
						</div>
					</div>
					<br>
...
<section class="inner_page">
	<div class="container my-5 border border-right-0 border-bottom-0 border-left-0">
		<div class="row mt-5">
			<c:forEach var="product" items="${requestScope.discountProductList}" begin="0" end="2">
			    <div class="row col">
			        <div class="col-4">
			...
			<c:forEach var="product" items="${requestScope.discountProductList}" begin="3" end="5">
			    <div class="row col">
			        <div class="col-4">
			            <a href="<%=ctxPath%>/product/detail.dk?product_seq=${product.product_seq}">
			                <img class="rounded" src="<%=ctxPath%>/images/product/${product.main_pic}" width="120" alt="...">
...
<section class="inner_page">
	<div class="container my-5">
		<div class="mb-3 row">
			<span class="col-10 h2">고고닭 인스타그램 <span class="h6 text-secondary">@gogodak_official&nbsp;&nbsp;#고고닭&nbsp;&nbsp;#소품닭&nbsp;&nbsp;#스테이크&nbsp;&nbsp;#큐브&nbsp;&nbsp;#크런치</span>
			</span> <a class="col-2 font-weight-bold text-right text-secondary" href="https://www.instagram.com/barudak_official/" target="_blank" style="align-content: center;"><i class="fa-solid fa-chevron-right"></i>&nbsp;&nbsp;더보기</a>
		</div>

		<ul class="nav justify-content-center insta_img">
			<li class="nav-item"><a class="nav-link pl-1 pr-1" href="https://www.instagram.com/p/C1B0Rp9r4Zd/" target="_blank"><img class="rounded" src="<%=ctxPath%>/images/index/instagram_img_1.jpg" width="175" alt="..."></a></li>
			<li class="nav-item"><a class="nav-link pl-1 pr-1" href="https://www.instagram.com/p/CzYmUWLvM9T/" target="_blank"><img class="rounded" src="<%=ctxPath%>/images/index/instagram_img_2.jpg" width="175" alt="..."></a></li>
			<li class="nav-item"><a class="nav-link pl-1 pr-1" href="https://www.instagram.com/p/CpUoTxWLanz/" target="_blank"><img class="rounded" src="<%=ctxPath%>/images/index/instagram_img_3.jpg" width="175" alt="..."></a></li>
			<li class="nav-item"><a class="nav-link pl-1 pr-1" href="https://www.instagram.com/p/CuyweCerkFu/" target="_blank"><img class="rounded" src="<%=ctxPath%>/images/index/instagram_img_4.jpg" width="175" alt="..."></a></li>
			<li class="nav-item"><a class="nav-link pl-1 pr-1" href="https://www.instagram.com/p/Czvjg_NrNKf/" target="_blank"><img class="rounded" src="<%=ctxPath%>/images/index/instagram_img_5.jpg" width="175" alt="..."></a></li>
			<li class="nav-item"><a class="nav-link pl-1 pr-1" href="https://www.instagram.com/p/Cyu_RbhrUDd/%20/" target="_blank"><img class="rounded" src="<%=ctxPath%>/images/index/instagram_img_6.jpg" width="175" alt="..."></a></li>
		</ul>

		<ul class="nav justify-content-center insta_img">
			<li class="nav-item"><a class="nav-link pl-1 pr-1 pt-0" href="https://www.instagram.com/p/Cz5ynYMry5b/" target="_blank"><img class="rounded" src="<%=ctxPath%>/images/index/instagram_img_7.jpg" width="175" alt="..."></a></li>
			<li class="nav-item"><a class="nav-link pl-1 pr-1 pt-0" href="https://www.instagram.com/p/Cv_7QoTL0Qk/" target="_blank"><img class="rounded" src="<%=ctxPath%>/images/index/instagram_img_8.jpg" width="175" alt="..."></a></li>
			<li class="nav-item"><a class="nav-link pl-1 pr-1 pt-0" href="https://www.instagram.com/p/CuWeo8NrMt6/" target="_blank"><img class="rounded" src="<%=ctxPath%>/images/index/instagram_img_9.jpg" width="175" alt="..."></a></li>
			<li class="nav-item"><a class="nav-link pl-1 pr-1 pt-0" href="https://www.instagram.com/p/C0_KWMSrZ0u/" target="_blank"><img class="rounded" src="<%=ctxPath%>/images/index/instagram_img_10.jpg" width="175" alt="..."></a></li>
			<li class="nav-item"><a class="nav-link pl-1 pr-1 pt-0" href="https://www.instagram.com/p/Cvl6N5YrowE/" target="_blank"><img class="rounded" src="<%=ctxPath%>/images/index/instagram_img_11.jpg" width="175" alt="..."></a></li>
			<li class="nav-item"><a class="nav-link pl-1 pr-1 pt-0" href="https://www.instagram.com/p/C0Q8dtvr9sw/" target="_blank"><img class="rounded" src="<%=ctxPath%>/images/index/instagram_img_12.jpg" width="175" alt="..."></a></li>
		</ul>
	</div>
</section>
<%-- end inner page section --%>
