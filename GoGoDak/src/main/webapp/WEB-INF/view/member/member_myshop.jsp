    	...
    	<div class="icons">
    		<li class="shopMain order">
       		...
       		<li class="shopMain profile">
	            ...
	            <h3><a href="#"><strong style="font-size: 18px;">Profile</strong><br><span style="font-size: 16px;">회원 정보</span></a></h3>
	            <p style="font-size: 12px;"><a href="#">회원이신 고객님의 개인정보를<br>관리하는 공간입니다.</a></p>
       		</li>
    	</div>
