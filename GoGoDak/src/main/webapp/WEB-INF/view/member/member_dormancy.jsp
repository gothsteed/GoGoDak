...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("button.btn-warning").click(function(){
			...
			frm.action = "<%= ctxPath%>/login/verifyCertification_dormancy.dk"; 
			frm.method = "post";
			frm.submit();
			//comman => verifyCertification_dormancy 추가
		});
	...
	function goFind(){
        ...
        const frm = document.dormancyFrm;
        frm.action = "<%= ctxPath%>/login/dormancy.dk";
        frm.method = "post";
        frm.submit();
      //comman => dormancy 추가
...
<div class="main-container">
    <div class="angry">
        <a href="<%= ctxPath%>/index.dk" class="mb-3 d-inline-block">←</a>
        <h1>휴면 해제</h1>
        <form name="dormancyFrm">
            <div class="form-group">
                <label for="userId">아이디</label>
                <input type="text" name="id" id="id" class="form-control" placeholder="아이디를 입력해주세요">
            </div>
            <div class="form-group">
                <label for="userEmail">가입하신 이메일</label>
