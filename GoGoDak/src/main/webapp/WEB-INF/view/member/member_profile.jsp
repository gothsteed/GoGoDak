...
function goEdit(){
    ...
    <tr>
        ...
        <td>
            <input type="hidden" name="userid" class="customWidth" value="${sessionScope.loginuser.id}" />
    ...
    <tr>
        ...
        <td>
            ...
            <input type="text" class="customWidth" name="detailAddress" id="detailAddress" size="40" maxlength="200" placeholder="상세주소" value="${sessionScope.loginuser.address_detail}" />&nbsp;<input type="text" name="extraAddress" id="extraAddress" size="40" maxlength="200" placeholder="참고항목" value="${sessionScope.mvo.address_extra}" />            
