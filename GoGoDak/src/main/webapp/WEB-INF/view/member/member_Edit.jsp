...
<script type="text/javascript">
	...
	function goWithdrawal(){
	    ...
	    if(checkbox_checked_length == 0){
	        ...
	        is_chk = false;
	        $("form.deleteFrm").reset();
			return;
	    }
	    
		const pwd = $("input#modalpwd").val().trim();
		if(pwd == "") {
	...
	<div class="row mt-5 mb-5" id="divEditFrm">
   		<div class="col-md-12">
      		...
      		<input type="reset" class="btn btn-outline-danger mr-3 ml-3" value="취소하기" onclick="goReset()" />
      		...
      		<div class="modal fade" id="memberWithdrawal" data-backdrop="static">
		   		<div class="modal-dialog">
		      		<div class="modal-content">
				    	<div style="text-align: center; position: relative; margin-top: 3%;">
				        	<h4 class="modal-title">회원탈퇴하기</h4>
				          	<button type="button" class="close withdrawalClose" id="my_close" data-dismiss="modal" style="position: absolute; right: 3%; top: 3%;">&times;</button>
				        </div>
				        <div class="modal-body">
				        	<div id="withdrawal" style="text-align: left;">
				             	...
				             	<br>
				             	<form class="deleteFrm" style="text-align: center;">
				             		...
				             		<br><br>
				             		<table id="tblMemberDel" style="width: 60%; margin: 0 auto;">
				             			<tbody>
				             				<tr>
										    	<td>비밀번호&nbsp;&nbsp;</td>
										        <td>
										        	<input type="hidden" name="id" value="${sessionScope.loginuser.id}" />
										            <input type="password" name="modalpwd" id="modalpwd" maxlength="15" class="requiredInfo mb-0" />
										        </td>
										    </tr>
				             			</tbody>
				             		</table>
