                ...
                <form name="boardFrm" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <!-- forEach 사용 선택한 것리스트 <보기리스트> 선택한 것 리스트 닫기 /  -->
                        ...
                        <div class="form-group">
                            <label for="price">상품가격 <span class="text-danger">*</span></label>
                            <input type="text" name="base_price" id="price" class="form-control infoData">
                            <span class="error"></span>
                        </div>
                        <div class="form-group">
                            <label for="description">제품설명 <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row mx-0">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-check">
                                        <input class="form-check-input infoData" type="radio" name="discount_type" id="noDiscount"  value="" style="margin-left: 35px;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col">
                                    <input type="file" name="main_pic" class="infoData img_file" accept="image/*">
                                    <span class="error"></span>
                                </div>
                            </div>
                        </div>
                        <!-- 상세 이미지 -->
                        <div class="form-group">
                            <label for="description_pic">상세 이미지</label>
                            <div class="row">
                                <div class="col">
                                    <input type="file" name="description_pic" class="infoData img_file" accept="image/*">
                                    <span class="error"></span>
                                </div>
                            </div>
                        </div>
